          ...
          <div class="bg-white/5 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10">
            <div class="max-w-none [&_h3]:text-white [&_h3]:font-bold [&_h3]:text-xl [&_h3]:md:text-2xl [&_h3]:mt-8 [&_h3]:mb-4 [&_h3]:first:mt-0 [&_h4]:text-white [&_h4]:font-semibold [&_h4]:text-lg [&_h4]:md:text-xl [&_h4]:mt-6 [&_h4]:mb-3 [&_p]:text-gray-300 [&_p]:leading-relaxed [&_p]:mb-4 [&_ul]:text-gray-300 [&_ul]:leading-relaxed [&_ul]:mb-4 [&_ul]:ml-6 [&_ul]:list-disc [&_ol]:text-gray-300 [&_ol]:leading-relaxed [&_ol]:mb-4 [&_ol]:ml-6 [&_ol]:list-disc [&_li]:mb-2">
              ...
              <p>
                ...
                on behalf of an entity ("you") and Hawk Softworks ("Company", "we", "us", or "our"), concerning
                your access to and use of the hawk-softworks.de website as well as any other media form, media
                ...
                agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF
              ...
              <p>
                ...
                Terms of Use; (2) take appropriate legal action against anyone who violates the law or these Terms of Use;
                (3) refuse, restrict access to, limit the availability of, or disable any of your Contributions;
                (4) remove from the Site or otherwise disable all files and content that are excessive in size;
              ...
              <p>
                We care about data privacy and security. Please be advised the Site is hosted in Germany.
                If you access the Site from any other region of the world, then through your continued use of the Site,
                you are transferring your data to Germany, and you agree to have your data transferred to and processed in Germany.
              </p>

              <!-- GOVERNING LAW -->
              <h3>GOVERNING LAW</h3>
              <p>
                These conditions are governed by and interpreted following the laws of Germany, and the use of
                the United Nations Convention of Contracts for the International Sale of Goods is expressly
                excluded. Hawk Softworks and yourself both agree to submit to the non-exclusive jurisdiction of
                the courts of Siegburg.
              </p>
              ...
              <p>
                ...
                damage, liability, claim, or demand made by any third party due to or arising out of:
                (1) use of the Site; (2) breach of these Terms of Use;
                (3) any breach of your representations and warranties; (4) your violation of third party rights;
                or (5) any harmful act toward any other user of the Site.
              </p>

              <!-- USER DATA -->
              <h3>USER DATA</h3>
              <p>
                We will maintain certain data that you transmit to the Site for managing performance.
                You are solely responsible for all data that you transmit or that relates to any activity
                using the Site. You agree that we shall have no liability for any loss or corruption of such data.
              </p>
              ...
              <p>
                ...
                communications. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS,
                AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES AND POLICIES.
              </p>

              <!-- MISCELLANEOUS -->
              <h3>MISCELLANEOUS</h3>
              <p>
                These Terms of Use constitute the entire agreement between you and us. Our failure to
                exercise any right shall not operate as a waiver. We may assign any of our rights at any time.
                If any provision is determined to be unlawful, that provision is deemed severable and does not
